import americanFlagPatch01 from './img/americanFlagPatch01.jpeg';

export default {
  name: 'american-flag-patch',
  ...
  form: `
    <form target="paypal" action="https://www.paypal.com/cgi-bin/webscr" method="post">
      ...
      <input type="hidden" name="hosted_button_id" value="L6HUTJ7LLU3B2">
      <input type="submit" name="submit" class="addToCartButton" value="Add to Cart">
    </form>
  `,
  price: '$35.00',
  isSoldOut: false,
  images: [americanFlagPatch01],
};
